...
location_df = pickle.load(open('pickles/location_distance.pkl', 'rb'))
cosine_sim1 = pickle.load(open('pickles/cosine_sim1.pkl', 'rb'))
cosine_sim2 = pickle.load(open('pickles/cosine_sim2.pkl', 'rb'))
cosine_sim3 = pickle.load(open('pickles/cosine_sim3.pkl', 'rb'))
link_loc = pickle.load(open('pickles/link_loc.pkl', 'rb'))
...
selected_location = st.selectbox('Location', sorted(location_df.columns.to_list()), index=21, placeholder='Select Location')
...
# Display images of recommended apartments through web scraping and recommender system pickle
headers = {
...
# Retry decoration config for sending request multiple times
